    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 dark:from-[#0a0f1f] dark:to-[#0a0f1f] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#111827] rounded-2xl shadow-xl w-full max-w-sm p-8 flex flex-col items-center gap-6">
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Ememora</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 text-center">
            Estude com flashcards e quizzes de forma inteligente.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="password" required placeholder="Sua senha" value={form.password} onChange={update("password")} className={inputClass} />
          </div>
          <button
            type="submit"
            disabled={loading}
